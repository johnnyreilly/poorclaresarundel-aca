...
export const Links: React.FC<React.PropsWithChildren<unknown>> = (_props) => (
  <>
    <h3 className="text-3xl font-bold dark:text-white">Links</h3>
    ...
    <p>
      <a
        href="http://www.prayingeachday.org"
        target="_blank"
        rel="noopener noreferrer"
      >
    ...
    <p>
      <a
        href="http://www.poorclaresedinburgh.org"
        target="_blank"
        rel="noopener noreferrer"
      >
        Humbie
    ...
    <p>
      <a
        href="http://www.franciscans.org.uk"
        target="_blank"
        rel="noopener noreferrer"
      >
