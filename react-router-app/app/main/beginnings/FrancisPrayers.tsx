...
export const FrancisPrayers: React.FC<React.PropsWithChildren<unknown>> = (
  _props
) => (
  <>
    ...
    <h3 className="text-3xl font-bold dark:text-white">
      St Francis of Assisi – His Prayers
    </h3>

    <h4>A Praising Prayer - Letter to the Entire Order</h4>

    <p>
      Almighty, eternal, just and merciful God grant us in our frailty the grace
      to do for you alone what we know you want us to do and always to desire
      what pleases you. Thus, inwardly cleansed, interiorly enlightened and
      inflamed by the fire of the Holy Spirit may we be able to follow in the
      footprints of your beloved Son, our Lord Jesus Christ. And, by your grace
      alone, may we make our way to you, Most High, who live and rule in perfect
      Trinity and simple Unity, and are glorified God all-powerful for ever and
      ever. Amen.
    </p>
    ...
    <p>
      All powerful, most holy, most high and supreme God; all good, supreme
      good, totally good, You who alone are good, may we give you all praise,
      all glory, all thanks, all honour, all blessing and all good things. So be
      it, so be it, Amen.
    </p>
    ...
    <p>
      ...
      yourselves, as well, that you may be exalted by him. Therefore Hold back
      nothing of yourselves for yourselves So that He who gives himself totally
