...
Christmas Day - 8.30am: Christmas Morning Mass, please join us for refreshments afterwards`,
  ...
  return (
    <>
      ...
      />
      <h3 className="text-3xl font-bold dark:text-white">Events</h3>

      <h4>Regular Events</h4>

      <p>
        The Poor Clares are glad to be able to welcome anyone who comes to join
        them in their times of prayer. Our regular timetable is:
      </p>
      ...
      <p>
        All times can be subject to occasional change, so if travelling a
        distance you might like to phone to check.
      </p>
