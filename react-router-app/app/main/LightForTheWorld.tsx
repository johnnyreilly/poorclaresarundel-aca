...
export const LightForTheWorld: React.FC<React.PropsWithChildren<unknown>> = (
  _props
) => (
  <>
      ...
      <CardImg
        ...
        src={
          new Date().getMonth() === 11
            ? oComeEmmanuelSmall
            : lightForTheWorldSmall
        }
      />
    </Card>

    <h3 className="text-3xl font-bold dark:text-white">Light for the World</h3>

    <p>
      Here is our album, &apos;Light for the World&apos; . Enjoy listening to
      our music. We hope it will help you find a place of peace and inner calm.
    </p>

    <p>
      <a href="https://PCOA.lnk.to/LightForTheWorldSo">
    ...
    <p>
      ...
      <a href="https://PCOA.lnk.to/OComeEmmanuelSo">
