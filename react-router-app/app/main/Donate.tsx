...
export const Donate: React.FC<React.PropsWithChildren<unknown>> = (_props) => {
  return (
    <>
      <h3 className="text-3xl font-bold dark:text-white">Donate</h3>
      <p>
        Many thanks for considering making a donation to support the life of
        prayer and praise of our Community at Crossbush. Your generosity is very
        much appreciated.
      </p>
