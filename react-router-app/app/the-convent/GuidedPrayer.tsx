...
export const GuidedPrayer: React.FC<React.PropsWithChildren<unknown>> = (
  _props
) => (
  <>
    ...
    <h3 className="text-3xl font-bold dark:text-white">
      Guided Prayer - Praying With the Seekers
    </h3>

    <p>
      When the Seekers were with us we had a time of guided prayer for them each
      Monday evening. Some of these prayer sessions are reproduced below, if you
      would like to try them yourself. Each session lasted 30-40 minutes, so
      allow plenty of time to pause between the different parts. At the end of
      each session we had a time of sharing, when each person was free to say
      how it had been for them, or to remain silent if they preferred not to
      share.
    </p>
    ...
    <p>
      St Ignatius of Loyola developed a pattern of looking back over the day,
      the week, the year, to see what is life-giving. It is a way of using
      little things to get in touch with our deepest desires, our most real
      selves, and when in touch with ourselves, we can make choices which are
      more life-giving for us. The exercise which follows has its roots in
      Ignatius’ Examen.
    </p>

    <p>
      Decide before starting whether you are looking at a day, a week, or what
      period.
    </p>
